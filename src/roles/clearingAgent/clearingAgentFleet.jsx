...
const ClearingAgentFleet = () => {
  ...
  // Importer Fleet Data - Only this importer's fleet
  const fleetData = [
    {
      id: 1,
                  ...
                  <div className={`p-4 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className={isDark ? 'text-white' : 'text-gray-900'}>{item.importer}</span>
                      </div>
                      {isShip && (
                        <>
                          <div className="flex justify-between">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
          <div className={`p-4 rounded-lg ${isDark ? 'bg-gray-800' : 'bg-white shadow-sm'}`}>
            <div className="flex items-center gap-2">
              ...
              <span className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>My Fleet</span>
            </div>
        ...
        <div className="space-y-3">
          ...
          {filteredFleet.length === 0 && (
            <div className={`text-center py-12 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
              ...
              <p className="text-lg font-medium">No fleet assets found</p>
...
export default ClreaingAgentFleet;