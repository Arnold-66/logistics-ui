// roles/exporter/ExporterFleet.jsx
...
const ExporterFleet = () => {
  ...
  // All fleet data with company association
  const allFleetData = [
    {
      id: 1,
